...
public class DirectedGraphCycleExample {
    public static void main(String[] args) {
        ...
        getOutgoingEdges(graph, "B", edges);

        // 输出顶点 B 向下的边
        System.out.println("Outgoing edges of vertex B: " + edges);
    }

    // 广度优先递归获取某个节点向下的边
    private static void getOutgoingEdges(Graph<String, DefaultEdge> graph, String vertex, List<DefaultEdge> edges) {
        // 创建一个队列，用于存储待处理的节点
